...
build: $(kernel_object_files) $(x86_64_object_files) $(libs_object_files) $(program_c_lse_files) $(program_lse_files) $(csh_object_files)
	mkdir -p dist/x86_64
...
run:
	docker exec -it myos_cpp make build_clean
